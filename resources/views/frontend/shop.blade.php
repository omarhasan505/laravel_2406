...
<link
   ...
   <link rel="stylesheet" href="{{ asset('ecobazar/assets/css/bootstrap.min.css') }}">
   <link rel="stylesheet" href="{{ asset('ecobazar/assets/css/shop.css') }}">
   <link rel="stylesheet" href="{{ asset('ecobazar/assets/css/shopResponsiv.css') }}">
         ...
         <div class="container">
            <ul>
               <li class="d-flex align-items-center">
                  <a href="{{ route('frontend.featured') }}" class="homeIcom">
                  ...
                  <div class="categories">
                     ...
                     <li class="shopCollapse">
                         <ul class="shopOpen active">
                           ...
                           <li class="d-flex align-items-center {{ $category->title }}">
                              <input type="radio" id="{{ $category->title }}" name="Categories">
                              <label for="{{ $category->title }}">{{ $category->title }}</span></label>
                           </li>
                           ...
                           <a href="#">
                              ...
                              <div class="details">
                                 ...
                                 <div class="priceAndCard d-flex align-items-center justify-content-between">
                                    <div class="price">
                                       <span class="col-2">{{ $product->discount_price }}</span>
                                        <span class="col-3 oldPrice">{{ $product->price }}</span>
                                    </div>
...
<script src="{{ asset('ecobazar/assets/js/bootstrap.bundle.min.js') }}"></script>
   <script src="{{ asset('ecobazar/assets/js/jquery-3.7.1.min.js') }}"></script>
   <script src="{{ asset('ecobazar/assets/js/main.js') }}"></script>
   <script src="{{ asset('ecobazar/assets/js/shop.js') }}"></script>
