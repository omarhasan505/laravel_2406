            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ Route::is('rolePermission.*') ? 'active open' : ''}}  ">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{ Route::is('rolePermission.create.user') ? 'active open' : '' }} ">
                                <a href="{{ route('rolePermission.create.user') }}" class="menu-link">
                                    <div data-i18n="Without menu">Create User</div>
                                </a>
                            </li>
                            <li class="menu-item {{ Route::is('rolePermission.list.user') ? 'active open' : '' }} ">
                                <a href="{{ route('rolePermission.list.user') }}" class="menu-link">
                                    <div data-i18n="Without menu">User List</div>
                                </a>
                            </li>
                            <li class="menu-item {{ Route::is('rolePermission.create.role') ? 'active open' : '' }}">
                                <a href="{{ route('rolePermission.create.role') }}" class="menu-link">
                    ...
                    <li class="menu-item {{ Route::is('products.*') ? 'active open' : ''}}  ">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{ Route::is('products.product.store') ? 'active open' : '' }} ">
                                <a href="{{ route('products.product.store') }}" class="menu-link">
