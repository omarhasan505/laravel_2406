...
@section('content')
        ...
        <div class="card shadow p-3">
            <div class="card-header d-flex justify-content-between align-item-center ">
                ...
                <div class="card-body">
                    <form action="{{ route('rolePermission.store.user') }}" method="post" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="col-lg-4 text-center position-relative">
                               ...
                               <label for="imgInp">
                                ...
                                <img id="user_image" style="max-width: 180px; cursor:pointer; border:1px solid #00000029 " class="img-fluid w-100 " src="{{ asset('backend/assets/img/add-image.jpg') }}" alt="">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <label for="user_email" class="mt-2">
                                            user email:
                                            <input type="email" placeholder="user email" name="user_email" class="form-control">
                                        </label>
                                    </div>
                                    <div class="col-lg-6">
                                   ...
                                   <div class="col">
                                     <button type="submit" class="btn btn-primary mt-3 p-2">Register New User</button>
                                   </div>
                                </div>
                            </div>
                        </div>
